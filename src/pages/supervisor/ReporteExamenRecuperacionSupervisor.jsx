...
import { getReporte,getReporteRecuperacion } from "../../services/reportes";
...
const StyledDataTable = styled(DataTable)`
  ...
  border-radius: 5px;
`;
const ReporteExamenRecuperacionSupervisor = ({ titulo }) => {
  ...
  const getReportes = async (page, perPage,selectEmpresa, capacitacion, mes, codigo, anio) => {
    const response = await getReporteRecuperacion(
      page,
      perPage,
      selectEmpresa,
      capacitacion,
  ...
  }, [page, selectCapacitacion,selectEmpresa, selectMes,codigoFiltro,añoFiltro]);
...
export default ReporteExamenRecuperacionSupervisor;
