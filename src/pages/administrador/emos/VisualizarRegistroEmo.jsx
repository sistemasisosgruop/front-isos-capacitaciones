...
const VisualizarRegistroEmo = () => {
  ...
  return (
    <div>
      <div className="flex flex-row md:flex-row gap-3 mb-2 w-full mt-2">
        <div className="flex flx-row w-full md:w-2/4 gap-3 ">
          <select
      ...
      <div className="flex flex-row md:flex-row gap-3 mb-2 w-12/12 mt-2 justify-between">
        <input
          type="text"
          name="nombre"
          placeholder="Busqueda"
          className="input input-bordered input-sm w-3/12"
          id="searchInput"
